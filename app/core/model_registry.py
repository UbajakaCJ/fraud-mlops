...
If no model found at all, API starts in degraded mode (503 on predict endpoints)
and retries loading on each /models/reload call.
"""
...
class ModelRegistry:
    ...
    def _load_sync(self):
        ...
        try:
            ...
            if production:
                mv = production[0]
                model_uri = f"models:/{settings.CHAMPION_MODEL_NAME}/Production"
        ...
        # No model anywhere — start in degraded mode, don't crash the API
